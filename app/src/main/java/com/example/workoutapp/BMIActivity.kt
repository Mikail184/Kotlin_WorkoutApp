        ...
        btnCalculateUnits.setOnClickListener {
            if(currentVisibleView.equals(METRIC_UNITS_VIEW)) {
                if(validateMetricUnit()) {
                    ...
                    Toast.makeText(this@BMIActivity, "Please enter your details", Toast.LENGTH_SHORT).show()
                }
            } else {
                if(validateUsUnit()) {
                    ...
                    val usUnitWeightValue: Float = etMUsUnitWeight.text.toString().toFloat()
